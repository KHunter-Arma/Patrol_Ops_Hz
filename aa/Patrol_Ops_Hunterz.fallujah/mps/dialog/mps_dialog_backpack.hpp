class mps_backpack_dialog {
	idd = 86009;
	movingEnable = true;
	enableSimulation = true;
	onLoad = "[] spawn mps_backpack_dialog_upd";
	...
	class controlsBackground {
		...
		class Title : HW_RscText {
			...
			w = 0.3; h = 0.03;
			sizeEx = 0.03;
			text = "Select a Backpack from the list";
		};
	...
	class controls {
		class Unitlist: HW_RscGUIListBox {
			...
			onLBDblClick = "";
			onLBSelChanged = "[] spawn mps_backpack_dialog_upd";
			rowHeight = 0.025;
