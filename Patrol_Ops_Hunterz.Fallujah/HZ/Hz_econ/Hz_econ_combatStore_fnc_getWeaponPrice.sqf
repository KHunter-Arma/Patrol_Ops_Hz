...
case "RH_M4_RIS": {-1};             
case "RH_M4_RIS_M203": {-1};         
case "RH_M4_RIS_M203S": {-1}; 
...
case "RH_M4_RIS_M_TG": {-1};
case "RH_M4_RIS_M_DES": {-1};	          
case "RH_M4_RIS_M_WDL": {-1};	
case "RH_M4A6_TG": {-1};
case "RH_M4A6_DES": {-1};	
case "RH_M4A6_WDL": {-1};	
...
case "RH_M16A4_M_TG": {-1};
case "RH_M16A4_M_DES": {-1};	
case "RH_M16A4_M_WDL": {-1};
