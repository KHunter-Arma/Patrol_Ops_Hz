...
/*--------------------CREATE TARGET-----------------------------------*/
    ...
    if((_x iskindof "LandVehicle") && ((_x emptyPositions "gunner") > 0)) then {

    _dude = (creategroup (SIDE_B select 0)) createUnit ["TK_Soldier_EP1", _position, [], 300, "NONE"];
