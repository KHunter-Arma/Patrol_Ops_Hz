...
_position = [_position,250,1,2] call mps_getFlatArea;
...
_vehicles = (mps_opfor_apc+mps_opfor_armor+mps_opfor_aa);
...
format["The enemy is doing field testing on some new technology integrated into a %1. Locate and capture the %1, then get it back safely to base to be examined.", _vehtype],
true,
