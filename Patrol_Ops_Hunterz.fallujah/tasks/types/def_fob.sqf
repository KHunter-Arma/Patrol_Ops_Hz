...
_position = [markerpos "ao_centre",2000,6700,SIDE_B select 0,10,true] call Hz_func_findspawnpos;
...
if(_b > 0) then { 
	...
	for "_i" from 1 to _b do {
		...
		if((count allunits) > Hz_max_allunits) exitwith {_r = (_b - _i) + 1; [_EnemySpawnMinimumRange,_position,_r,"TRUCK",_CASchance,_TankChance,_IFVchance,_AAchance,_CarChance] call Hz_task_reinforcements;};
