...
private ["_pos","_nearobjects","_obj","_EHKilled","_EHHit","_postruck","_truck","_cargo"];
...
_EHKilled = _truck addMPeventhandler ["MPKilled",{
_truck = _this select 0; 
_cargo = _truck getvariable "Cargo";
_cargo setdamage 1;
}];
_truck setvariable ["EHKilled",_EHKilled,true];

_EHHit = _truck addMPeventhandler ["MPHit",{
_truck = _this select 0;
...
_truck setvariable ["EHHit",_EHHit,true];
...
_EHKilled = _truck getvariable "EHKilled";
_EHHit = _truck getvariable "EHHit";
_truck removempeventhandler ["MPKilled",_EHKilled];
_truck removempeventhandler ["MPHit",_EHHit];
