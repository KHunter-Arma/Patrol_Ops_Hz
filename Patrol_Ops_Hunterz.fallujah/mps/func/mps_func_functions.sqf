...

{
  ...
  if( (_x select 0) == (SIDE_C select 1) ) then {
    ...
    case "truck": { mps_opfor_ins_truck = mps_opfor_ins_truck + [(_x select 2)]};
		...
		case "mobiaa": { mps_opfor_ins_aa = mps_opfor_ins_aa + [(_x select 2)]};
		case "tank": { mps_opfor_ins_armor  = mps_opfor_ins_armor  + [(_x select 2)]};
    case "apc": { mps_opfor_ins_apc = mps_opfor_ins_apc + [(_x select 2)]};
      default {  };
    };
  };
