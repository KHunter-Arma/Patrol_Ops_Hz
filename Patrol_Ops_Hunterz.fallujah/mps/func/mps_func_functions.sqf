...
*/
  ...
  if( (_x select 0) == (SIDE_B select 1) && (_x select 1) in ["aa","at","mg","sn","dm","tl","med","rf","spc","gl"] ) then {
  ...
  if( (_x select 0) == (SIDE_C select 1) && (_x select 1) in ["aa","at","mg","sn","dm","tl","med","rf","spc","gl"] ) then {
