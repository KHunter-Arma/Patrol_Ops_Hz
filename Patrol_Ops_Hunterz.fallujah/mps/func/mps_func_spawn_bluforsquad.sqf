...
switch _type do{
case "INF": {_allunits = mps_blufor_inf};
case "INS": {_allunits = mps_blufor_inf}; // friendly insurgents in future?
case "TARGET" : {_allunits = mps_blufor_leader};
  default {_allunits = mps_blufor_inf};
};
