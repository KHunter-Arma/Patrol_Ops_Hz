//class Params {
	class option00 { //MISSIONTIME	Mission: Operation Time
		...
		default=-1;
		texts[]={"Real time (GMT-5)","0030H","0130H","0230H","0330H","0430H","0530H","0630H","0730H","0830H","0930H","1030H","1130H","1230H","1330H","1430H","1530H","1630H","1730H","1830H","1930H","2030H","2130H","2230H","2330H"};
	};
