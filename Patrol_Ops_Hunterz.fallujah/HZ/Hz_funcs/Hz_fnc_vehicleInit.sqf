...
if (_vehicle isKindOf "LandVehicle") then {
	...
	_initstatement = _initstatement + "_obj addAction ['<t color=''#FF0000''>Flip vehicle</t>','vehicle_flip.sqf' , nil, 1.5, true, true, '', '(((vectorUp _target) select 2) < 0) && ((vehicle _this) != _this)', 6, false, ''];";
