...
CASE "RHS_GDM40": {0};
CASE "HLC_GRD_BLUE": {0};
CASE "HLC_GRD_GREEN": {0};
CASE "HLC_GRD_ORANGE": {0};
CASE "HLC_GRD_PURPLE": {0};
CASE "HLC_GRD_RED": {0};
CASE "HLC_GRD_WHITE": {0};
CASE "HLC_GRD_YELLOW": {0};
CASE "RHS_GRD40_GREEN": {0};
CASE "RHS_GRD40_RED": {0};
CASE "RHS_GRD40_WHITE": {0};
CASE "RHS_VG40MD_GREEN": {0};
CASE "RHS_VG40MD_RED": {0};
CASE "RHS_VG40MD_WHITE": {0};
CASE "RHS_VG40OP_GREEN": {0};
CASE "RHS_VG40OP_RED": {0};
CASE "RHS_VG40OP_WHITE": {0};
CASE "RHS_VG40SZ": {0};
CASE "RHS_VG40TB": {0};
CASE "RHS_VOG25": {0};
CASE "HLC_VOG25_AK": {0};
