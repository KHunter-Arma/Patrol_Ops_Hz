...
case "HLC_OPTIC_STANAGZF2G_G3": {700};
case "HLC_OPTIC_STANAGZF_G3": {700};
case "HLC_OPTIC_ZFSG1": {600};
case "HLC_OPTIC_ZF95_G3": {1500};
case "HLC_OPTIC_LEUPOLDM3A_G3": {1600};
case "HLC_OPTIC_ACCUPOINT_G3": {1000};

case "HLC_MUZZLE_SNDS_ROTEX3P": {80};
case "HLC_MUZZLE_GUNFIGHTER_COMP": {100};
case "HLC_MUZZLE_KX3_COMP": {125};
case "HLC_MUZZLE_SF3P_762R": {114};
