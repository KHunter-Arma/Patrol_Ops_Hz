	...
	movingenable = true;
		...
		class Controls {
			...
			class HZ_veh_list: RscListbox
			{
				...
				onLBSelChanged="call HZ_veh_update_dialog;";
			};
			class HZ_veh_pic: RscPicture
			{
				idc = 3134;
			...
			class HZ_veh_button_buy: RscButton
			{
				idc = 3137;
				text = "Buy Vehicle";
				...
				action = "closeDialog 0; call HZ_veh_createveh;";
			};
			class HZ_veh_version: RscText
			{
				idc = 3138;
				text = "v0.1";
			...
			class HZ_veh_button_exit: RscButton
			{
				idc = 3139;
				text = "Exit";
			...
			class HZ_veh_title: RscText
			{
				idc = 3140;
				text = "Hunter'z Vehicle Store";
				style = ST_CENTER;
				colorBackground[] = {0,0,0,1};
				colorText[] = {1,0,0,.9};
				SizeEx = 0.1;
				x = 0.303126 * safezoneW + safezoneX;
				y = 0.169166 * safezoneH + safezoneY;
				w = 0.412501 * safezoneW;
				h = 0.1 * safezoneH;
			};
			class HZ_veh_info: RscText
			{
				idc = 3141;
