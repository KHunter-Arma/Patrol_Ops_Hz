...
{
	_objet addAction [("<t color=""#00eeff"">" + format [STR_R3F_LOG_action_deplacer_objet, _nom] + "</t>"), {_this call R3F_LOG_FNCT_objet_deplacer}, false, 5, false, true, "", "!R3F_LOG_mutex_local_verrou && (R3F_LOG_objet_addAction == _target && R3F_LOG_action_deplacer_objet_valide) && alive _target"];
};
...
if (_fonctionnalites select __can_be_transported_cargo) then
{
	...
	_objet addAction [("<t color=""#dddd00"">" + format [STR_R3F_LOG_action_selectionner_objet_charge, _nom] + "</t>"), {_this call R3F_LOG_FNCT_transporteur_selectionner_objet}, nil, 5, false, true, "", "!R3F_LOG_mutex_local_verrou && (R3F_LOG_objet_addAction == _target && R3F_LOG_action_selectionner_objet_charge_valide) && alive _target"];
};
